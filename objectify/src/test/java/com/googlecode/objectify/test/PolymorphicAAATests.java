...
/**
 * Just the registration part of polymorphic classes. The 'A' just to alphabetize it before the other polymorphic tests.
 * 
...
public class PolymorphicAAATests extends TestBase {
  ...
  /**
   * This seems reasonable behavior, better than filtering mismatched values out of the result. We like this behavior
