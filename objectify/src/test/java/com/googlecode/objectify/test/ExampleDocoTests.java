...
/**
 * Tests that a certain-shaped Town results in the correct datastore Entity. The to-string of the Entity is also
 * cut-and-pasted into the Wiki documentation
 */
public class ExampleDocoTests extends TestBase {
  ...
  public void testFirstExample() throws Exception {
    ...
    town.folk = new Someone[] {
        new Someone(new Name("Homer", "Simpson"), 39), new Someone(new Name("Apu", "Nahasapeemapetilon"), 48)};
