...
/**
 * Tests of the caching datastore directly, outside of the rest of Objectify. Tries to create as few future wrappers as
 * possible so we can easily see what is going on.
 * 
