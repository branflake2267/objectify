...
/**
 * This datastore service throws UnsupportedOperationException from every method call immediately. It allows us to test
 * that the cache layer is working properly - when cached, it shouldn't make any calls here.
 */
