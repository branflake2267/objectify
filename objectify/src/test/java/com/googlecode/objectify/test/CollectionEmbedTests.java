...
public class CollectionEmbedTests extends TestBase {
  ...
  public static class HashableThing {
    ...
    public boolean equals(Object obj) {
      return value.equals(((HashableThing) obj).value);
    }
  ...
  public static class HasDeepThings {
    ...
    @Override
    public String toString() {
      return this.getClass().getSimpleName() + "(" + deeps + ")";
    }
  }
  ...
  public static class DeepThing {
    ...
    public DeepThing(int val) {
      this.thing = new HashableThing(val);
    }

    @Override
    public String toString() {
      return this.getClass().getSimpleName() + "(" + thing + ")";
    }
  }
