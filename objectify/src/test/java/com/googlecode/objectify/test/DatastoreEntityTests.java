...
/**
 * This is a set of tests that clarify exactly what happens when you put different kinds of entities into the datastore.
 * They aren't really tests of Objectify, they just help us understand the underlying behavior.
 * 
