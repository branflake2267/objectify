...
/**
 * Tests of transactional behavior. Since many transactional characteristics are determined by race conditions and other
 * realtime effects, these tests are not very thorough. We will assume that Google's transactions work.
 * 
...
public class TransactionTests extends TestBase {
  ...
  public void testSimpleTransaction() throws Exception {
    ...
    try {
      ...
      if (tOfy.getTxn().isActive()) tOfy.getTxn().rollback();
    }
