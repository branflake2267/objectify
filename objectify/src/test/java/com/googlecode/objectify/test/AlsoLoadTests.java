...
public class AlsoLoadTests extends TestBase {
  ...
  static class HasAlsoLoadField {
    ...
    public HasAlsoLoadField(String value) {
      this.foo = value;
    }
  ...
  static class HasAlsoLoadMethod {
    ...
    public HasAlsoLoadMethod(String value) {
      this.foo = value;
    }
  ...
  static class HasEmbedded {
    @Id
    Long id;
    @AlsoLoad("oldFieldUser")
    @Embed
    HasAlsoLoadField fieldUser;
    @AlsoLoad("oldMethodUser")
    @Embed
    HasAlsoLoadMethod methodUser;
  }
  ...
  static class HasEmbeddedArray {
    @Id
    Long id;
    @AlsoLoad("oldFieldUsers")
    @Embed
    HasAlsoLoadField[] fieldUsers;
    @AlsoLoad("oldMethodUsers")
    @Embed
    HasAlsoLoadMethod[] methodUsers;
  }
  ...
  static class HasAlsoLoads {
    ...
    public void setOtherStuff(String value) {
      this.otherStuff = value;
    }
  ...
  public void testEasyHasEmbeddedArray() throws Exception {
    ...
    HasAlsoLoadField[] expectedFieldUsers = new HasAlsoLoadField[] {
        new HasAlsoLoadField(TEST_VALUE), new HasAlsoLoadField(TEST_VALUE)};
    HasAlsoLoadMethod[] expectedMethodUsers = new HasAlsoLoadMethod[] {
        new HasAlsoLoadMethod(TEST_VALUE), new HasAlsoLoadMethod(TEST_VALUE)};
