...
public class ValueTranslationTests extends TestBase {
  ...
  /**
   * Strings greater than 500 chars get converted to Text and back. This has some potentially odd effects.
   */
  @Test
  ...
  public void testAddedConversion2() throws Exception {
    this.fact.getTranslators().add(new ValueTranslatorFactory<BigDecimal, String>(BigDecimal.class) {
      @Override
      protected ValueTranslator<BigDecimal, String> createSafe(Path path, Property property, Type type,
          CreateContext ctx) {
