...
public class EmbedTests extends TestBase {
  public static class PartiallyIndexedStruct {
    @Embed
    @Index
    Someone indexedPerson;
    @Embed
    @Unindex
    Someone unindexedPerson;
  ...
  public static class PartiallyIndexedEntity {
    ...
    @Embed
    @Index
    PartiallyIndexedStruct indexed;
    @Embed
    @Unindex
    PartiallyIndexedStruct unindexed;
  ...
  public void testUnindexed() throws Exception {
    ...
    PartiallyIndexedEntity obj = new PartiallyIndexedEntity(new PartiallyIndexedStruct(new Someone(new Name("A", "B"),
        30), new Someone(new Name("C", "D"), 31), "1", "2"), new PartiallyIndexedStruct(new Someone(new Name("a", "b"),
        32), new Someone(new Name("c", "d"), 33), "3", "4"));
