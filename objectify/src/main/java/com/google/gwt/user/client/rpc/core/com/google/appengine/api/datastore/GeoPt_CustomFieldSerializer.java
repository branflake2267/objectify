...
public class GeoPt_CustomFieldSerializer {
  public static void deserialize(SerializationStreamReader streamReader, GeoPt instance) throws SerializationException {
    // already handled in instantiate
  }

  public static GeoPt instantiate(SerializationStreamReader streamReader) throws SerializationException {
    return new GeoPt(streamReader.readFloat(), streamReader.readFloat());
  }

  public static void serialize(SerializationStreamWriter streamWriter, GeoPt instance) throws SerializationException {
