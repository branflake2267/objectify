...
public class Category_CustomFieldSerializer {
  ...
  public static Category instantiate(SerializationStreamReader streamReader) throws SerializationException {
    return new Category(streamReader.readString());
  }

  public static void serialize(SerializationStreamWriter streamWriter, Category instance) throws SerializationException {
