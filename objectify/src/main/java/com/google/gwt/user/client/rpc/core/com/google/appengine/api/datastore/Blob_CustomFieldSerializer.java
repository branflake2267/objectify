...
public class Blob_CustomFieldSerializer {
  public static void deserialize(SerializationStreamReader streamReader, Blob instance) throws SerializationException {
    // already handled in instantiate
  }

  public static Blob instantiate(SerializationStreamReader streamReader) throws SerializationException {
    byte[] bytes;
  ...
  public static void serialize(SerializationStreamWriter streamWriter, Blob instance) throws SerializationException {
