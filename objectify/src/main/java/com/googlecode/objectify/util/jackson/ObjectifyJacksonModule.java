...
/**
 * Call jackson's {@code ObjectMapper.registerModule(new ObjectifyJacksonModule())} to enable intelligent serialization
 * and deserialization of various Objectify and GAE classes.
 */
