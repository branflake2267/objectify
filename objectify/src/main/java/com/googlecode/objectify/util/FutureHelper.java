...
public class FutureHelper {
  ...
  /**
   * Properly unwraps ExecutionException, throwing the relevant original cause. Otherwise RuntimeExceptions get thrown
   * and checked exceptions get wrapped in a RuntimeException.
   */
