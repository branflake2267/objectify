...
abstract public class ResultCache<T> implements Result<T>, Serializable {
  ...
  /**
   * When this serializes, write out a simple version that doesn't hold complicated links to internal structures. This
   * is safe as long as nobody ever tries to cast to ResultCache directly, which should never happen.
   */
  ...
  public String toString() {
    // Type from = GenericTypeReflector.getTypeParameter(this.getClass(),
    // ResultTranslator.class.getTypeParameters()[0]);
