...
/**
 * Exception thrown when a fetch for something could not be found. This is associated with the getSafe() and keySafe()
 * methods on Ref; if the item being sought in the Ref couldn't be found, this will be thrown.
 */
