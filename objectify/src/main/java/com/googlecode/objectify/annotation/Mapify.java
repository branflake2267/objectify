 ...
 * 
 * <p>
 * The field must be of type {@code Map}. An instance of the Mapper will be created and used to extract a key from each
 * value; this will become the key of the map. The actual value stored in the datastore will be a simple list of the map
 * values.
 * </p>
 * 
