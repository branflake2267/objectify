...
/**
 * Holder of the master ObjectifyFactory and provider of the current thread-local Objectify instance. Call {@code ofy()}
 * at any point to get the current Objectify with the correct transaction context.
 * 
...
public class ObjectifyService {
  ...
  public static Objectify ofy() {
    ...
    if (stack.isEmpty()) stack.add(factory.begin());
