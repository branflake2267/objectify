...
/**
 * Once you have narrowed your interest to a type (via {@code load().type(SomeType.class)}), the command pattern can
 * diverge into two directions: Either defining a parent or ids (which corresponds to a batch get) or calling
 * query-related methods (which will produce a query).
 * 
