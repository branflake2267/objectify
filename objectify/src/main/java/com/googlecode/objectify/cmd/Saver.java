...
public interface Saver {
   ...
   * 
   * <p>
   * If the entity has a null Long id, the value will be autogenerated and populated on the entity object when the async
   * operation completes. If you require this value, call now() on the result.
   * </p>
   * 
   * <p>
   * Puts do not cascade.
   ...
   * 
   * <p>
   * If any entities have null Long ids, the values will be autogenerated and populated on the entity objects when the
   * async operation completes. If you require these values, call now() on the result.
   * </p>
   * 
   * <p>
   * Puts do not cascade.
