 ...
 * 
 * <p>
 * You can delete entities by either passing in the POJO or their keys. Note that deletes do NOT cascade; you must
 * delete each individual entity in an object graph.
 * </p>
 * 
 * <p>
...
public interface Deleter {
   ...
   * </p>
   * 
   * @param entity can be an entity or any key-like structure; a Key<?>, a native datastore Key, or an entity object
   *          with valid id/parent fields.
   * @return an asynchronous Result. Call now() to force synchronous deletion.
   */
   ...
   * </p>
   * 
   * @param entities can be entity instances or any key-like structure; a Key<?>, a native datastore Key, or an entity
   *          object with valid id/parent fields.
   * @return an asynchronous Result. Call now() to force synchronous deletion.
   */
