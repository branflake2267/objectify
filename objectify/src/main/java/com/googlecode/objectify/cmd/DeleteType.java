...
/**
 * <p>
 * After a type is specified, the next step in a delete chain is to specify an optional parent or a set of ids. This is
 * part of
 * </p>
 * 
 * <p>
...
public interface DeleteType extends DeleteIds {
  /**
   * Defines the parent part of a key (or set of keys) when building a delete request. After this you will define the id
   * or ids to delete.
   * 
