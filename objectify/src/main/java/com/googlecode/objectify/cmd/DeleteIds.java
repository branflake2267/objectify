...
/**
 * <p>
 * Terminator methods for a delete-by-key command chain which constructs the key implicitly from type, id, and
 * (optionally) parent.
 * </p>
 * 
 * <p>
...
public interface DeleteIds {
   ...
   * </p>
   * 
   * @param id - the id of the entity to delete. Note that numeric ids and String ids are not equivalent; 123 and "123"
   *          are different ids.
   ...
   * </p>
   * 
   * @param ids - the ids of the entity to delete. Note that numeric ids and String ids are not equivalent; 123 and
   *          "123" are different ids.
   * @return an asynchronous Result of the deletion. Force synchronous delete by calling Result.now().
   */
   ...
   * </p>
   * 
   * @param ids - the ids of the entities to delete. The Iterator must provide Long or String. Note that numeric ids and
   *          String ids are not equivalent; 123 and "123" are different ids.
   * @return an asynchronous Result of the deletion. Force synchronous delete by calling Result.now().
   */
