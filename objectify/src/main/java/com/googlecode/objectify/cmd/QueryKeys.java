...
/**
 * <p>
 * After you call Query.keys(), you are executing a keys-only query. This is the command structure. It offers only
 * terminators; if you wanted additional filtering, add it before keys().
 * </p>
 * 
 * <p>
 * There is one additional method beyond the standard QueryExecute interface: the {@code asEntities()} method lets you
 * return your keys as partial entities.
 * </p>
 * 
