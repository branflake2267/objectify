...
/**
 * <p>
 * Terminator methods for a fetch-by-key command chain which constructs the key implicitly from type, id, and
 * (optionally) parent.
 * </p>
 * 
 * <p>
...
public interface LoadIds<T> {
   ...
   * </p>
   * 
   * @param id - the id of the entity to fetch. Note that numeric ids and String ids are not equivalent; 123 and "123"
   *          are different ids.
   ...
   * </p>
   * 
   * @param ids - the ids of the entity to fetch. Note that numeric ids and String ids are not equivalent; 123 and "123"
   *          are different ids.
   ...
   * </p>
   * 
   * @param ids - the ids of the entities to fetch. The Iterator must provide Long or String. Note that numeric ids and
