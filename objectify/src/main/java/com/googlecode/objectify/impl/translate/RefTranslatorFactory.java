...
public class RefTranslatorFactory extends ValueTranslatorFactory<Ref<?>, com.google.appengine.api.datastore.Key> {
  ...
  @Override
  protected ValueTranslator<Ref<?>, com.google.appengine.api.datastore.Key> createSafe(Path path,
      final Property property, Type type, CreateContext ctx) {
    return new ValueTranslator<Ref<?>, com.google.appengine.api.datastore.Key>(path,
      ...
      protected com.google.appengine.api.datastore.Key saveValue(Ref<?> value, SaveContext ctx) {
        if (value.getValue() == null) ctx.registerUpgrade(property, value);
