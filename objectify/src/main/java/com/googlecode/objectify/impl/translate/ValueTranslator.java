...
/**
 * <p>
 * Helper which helps take a mapnode's property value and converts it from datastore representation to pojo
 * representation. Note that null checking has already been done.
 * </p>
 * 
...
abstract public class ValueTranslator<P, D> extends PropertyValueNodeTranslator<P> {
   ...
   * 
   * @see
   * com.googlecode.objectify.impl.translate.PropertyValueNodeTranslator#loadPropertyValue(com.googlecode.objectify.
   * impl.Node, com.googlecode.objectify.impl.translate.LoadContext)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.googlecode.objectify.impl.translate.PropertyValueNodeTranslator#savePropertyValue(java.lang.Object,
  ...
  /**
   * Encode from a normal pojo value to a format that the datastore understands. Note that a null return value is a
   * literal instruction to store a null.
   * 
   * @param value will not be null, that has already been tested for
