...
public class SaveContext {
  ...
  /**
   * Potential upgrades found during the save process; key is the pojo entity itself (its identity). The problem is that
   * when saving, the id may not be set yet, so we can't track keys.
   */
