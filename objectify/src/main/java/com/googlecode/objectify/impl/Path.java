...
public class Path {
  /**
   * Unfortunately, we made a mistake in the original definition of the ^null property for embedded collections. Instead
   * of thing.^null we defined it as thing^null, which requires special casing. So we are fixing this now - we read
   * thing^null as thing.^null, and always save as thing.^null. Some day in the far future we can remove this hack.
   */
