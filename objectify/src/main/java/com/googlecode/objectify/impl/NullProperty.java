...
/**
 * Property to use with translators when there isn't a relevant property; for example, when making a filterable or when
 * creating translator for the root entity. Don't construct it, just use the INSTANCE.
 */
