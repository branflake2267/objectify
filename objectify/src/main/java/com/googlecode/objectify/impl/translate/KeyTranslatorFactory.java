...
public class KeyTranslatorFactory extends ValueTranslatorFactory<Key<?>, com.google.appengine.api.datastore.Key> {
  ...
  @Override
  protected ValueTranslator<Key<?>, com.google.appengine.api.datastore.Key> createSafe(Path path, Property property,
      Type type, CreateContext ctx) {
    return new ValueTranslator<Key<?>, com.google.appengine.api.datastore.Key>(path,
