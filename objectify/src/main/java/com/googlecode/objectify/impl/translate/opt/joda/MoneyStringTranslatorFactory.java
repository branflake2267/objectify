...
/**
 * Stores Money as its string representation. Note that this does not index properly; you can't safely use inequality
 * filters. However, indexing is not always necessary and this is a very useful thing to be able to store.
 * 
...
public class MoneyStringTranslatorFactory extends ValueTranslatorFactory<Money, String> {
  ...
  @Override
  protected ValueTranslator<Money, String> createSafe(Path path, Property property, Type type, CreateContext ctx) {
