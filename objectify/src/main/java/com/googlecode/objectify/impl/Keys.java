...
/**
 * <p>
 * Holds static metadata about entity keys. Since key information is defined by static annotations, it's safe to
 * maintain the metadata in a static context. There is no synchronization; you are expected to perform all registration
 * at app startup.
 * </p>
 * 
 * <p>
 * Note that this is an internal mechanism which shouldn't be relied upon by the public; use Key.create(pojo) instead.
 * </p>
 * 
...
public class Keys {
  ...
  /**
   * <p>
   * Gets the Key<T> given an object that might be a Key, Key<T>, or entity.
   * </p>
   * 
  ...
  /**
   * <p>
   * Gets the raw datstore Key given an object that might be a Key, Key<T>, or entity.
   * </p>
   * 
   * @param keyOrEntity must be a Key, Key<T>, or registered entity.
   * @throws NullPointerException if keyOrEntity is null
