...
/**
 * <p>
 * A convenient static method that adds all the joda-time related converters to your factory's conversions. We can't
 * enable the joda-time converters automatically or it would force everyone to add joda-time.jar whether they use it or
 * not. To enable, call this:
 * </p>
 * 
 * <p>
 * {@code JodaTimeTranslators.add(ObjectifyService.factory());}
 * 
