...
/**
 * <p>
 * A translator knows how to load an entity Node subgraph into a POJO object. When an entity class is registered, the
 * known TranslatorFactories are queried to produce Translator objects for each field. These translators are permanently
 * associated with the entity metadata so they do not need to be discovered at normal runtime.
 * </p>
 * 
 * <p>
 * Translators are composed of other translators; through a chain of these a whole entity object is assembled or
 * disassembled. Factories can use {@code CreateContext.getFactory().getTranslators()} to create these nested translator
 * instances for component types.
 * </p>
 * 
