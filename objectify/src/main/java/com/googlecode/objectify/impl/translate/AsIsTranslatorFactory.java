...
/**
 * <p>
 * This should be the last translator in the list - the one to try when nothing else wants the type. It just copies the
 * value as-is. This is used for simple values that get stored natively; GeoPt, Email, etc. It will also end up trying
 * to save any random value whether it can be saved or not. The datastore will complain when the entity property is set.
 * </p>
 * 
 * <p>
