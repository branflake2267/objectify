...
/**
 * The information we maintain on behalf of an entity instance in the session cache. Normally this would just be a
 * Result<?>, but we also need a list of upgrades so that future loads with groups will patch up further references.
 * 
