...
abstract public class AbstractTranslator<T> implements Translator<T> {
   ...
   * (non-Javadoc)
   * 
   * @see com.googlecode.objectify.impl.translate.Translator#load(com.googlecode.objectify.impl.Node,
  ...
  final public T load(Node node, LoadContext ctx) {
    ...
    if (log.isLoggable(Level.FINEST))
      log.logp(Level.FINEST, this.getClass().getName(), "load",
          LogUtils.msg(node.getPath(), "Loaded " + node + " to " + obj));
   ...
   * (non-Javadoc)
   * 
   * @see com.googlecode.objectify.impl.translate.Translator#save(java.lang.Object, com.googlecode.objectify.impl.Path,
   * boolean, com.googlecode.objectify.impl.translate.SaveContext)
   */
  @Override
