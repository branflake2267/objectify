 ...
 * 
 * <p>
 * Note that empty or null arrays are not stored in the datastore, and null values for the array field are ignored when
 * they are loaded from the Entity. This is because the datastore doesn't store empty collections, and storing null
 * fields will confuse filtering for actual nulls in the array contents.
 * </p>
 * 
...
public class ArrayTranslatorFactory implements TranslatorFactory<Object> {
  ...
  public Translator<Object> create(Path path, final Property property, Type type, CreateContext ctx) {
    ...
    try {
      ...
      final Translator<Object> componentTranslator = ctx.getFactory().getTranslators().create(path, property,
          componentType, ctx);
      ...
      return new ListNodeTranslator<Object>() {
        ...
        protected Node saveList(Object pojo, Path path, boolean index, SaveContext ctx) {
          ...
          if (len == 0) throw new SkipException();
