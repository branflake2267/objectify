 ...
 * These are just shortcuts for common cases - do not be afraid to use the constructors of CachingDatastoreService or
 * CachingAsyncDatastoreService to create an interface tailored exactly to your caching needs.
 * </p>
 * 
...
public class CachingDatastoreServiceFactory {
  ...
  public static void setDefaultMemcacheNamespace(String value) {
    defaultMemcacheNamespace = value;
  }
  ...
  /**
   * Get a caching DatastoreService that uses a particular EntityMemcache configuration. Ignores the default
   * memcacheService for this factory; that is set when you construct your EntityMemcache.
   */
  ...
  /**
   * Get a caching AsyncDatastoreService that uses a particular EntityMemcache configuration. Ignores the default
   * memcacheService for this factory; that is set when you construct your EntityMemcache.
   */
