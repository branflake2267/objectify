...
/**
 * <p>
 * Dynamic proxy which wraps a MemcacheService and adds retries when an exception occurs. It logs and masks exceptions
 * on complete failure.
 * </p>
 * 
...
public class MemcacheServiceRetryProxy implements InvocationHandler {
  ...
  public static MemcacheService createProxy(MemcacheService raw, int retryCount) {
    ...
    return (MemcacheService) java.lang.reflect.Proxy.newProxyInstance(raw.getClass().getClassLoader(),
        raw.getClass().getInterfaces(), new MemcacheServiceRetryProxy(raw, retryCount));
  }
