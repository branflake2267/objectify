 ...
 * A "best effort" is made to ensure execution, but it may be left untriggered until the end of a request.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Use the AsyncCacheFilter for normal requests. For situations where a filter is not appropriate (ie, the remote api)
 * be sure to call PendingFutures.completeAllPendingFutures() manually.
 * </p>
 * 
...
abstract public class TriggerFuture<T> implements Future<T> {
  ...
  /**
   * This method will be called ONCE upon completion of the future, successful or not. Beware that this.get() may throw
   * an exception.
   */
