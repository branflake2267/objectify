...
public class CachingDatastoreService implements DatastoreService {
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#allocateIds(com.google.appengine.api.datastore.Key,
   ...
   * 
   * @see
   * com.google.appengine.api.datastore.DatastoreService#allocateIdRange(com.google.appengine.api.datastore.KeyRange)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#beginTransaction(com.google.appengine.api.datastore.
   * TransactionOptions)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#delete(com.google.appengine.api.datastore.Transaction,
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#get(com.google.appengine.api.datastore.Transaction,
   * com.google.appengine.api.datastore.Key)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#getCurrentTransaction(com.google.appengine.api.datastore.
   * Transaction)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#prepare(com.google.appengine.api.datastore.Transaction,
   ...
   * (non-Javadoc)
   * 
   * @see com.google.appengine.api.datastore.DatastoreService#put(com.google.appengine.api.datastore.Transaction,
