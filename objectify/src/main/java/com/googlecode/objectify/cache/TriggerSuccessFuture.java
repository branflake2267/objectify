...
/**
 * <p>
 * Extends TriggerFuture so that it only gets triggered on successful (no exception) completion of the Future. This
 * prevents, for example, cache put()s from firing when concurrency exceptions are thrown.
 * </p>
 * 
