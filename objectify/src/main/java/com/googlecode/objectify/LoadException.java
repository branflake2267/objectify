...
/**
 * Thrown when something went wrong during the load translation process; for example, the data in the datastore might be
 * in a format incompatible with the intended pojo field. Indicates what went wrong with which entity.
 */
